            ...
            {desktopTabs.map((tab) => {
              ...
              if (tab.type !== "link") {
                return (
                  <button
                    ...
                    className="relative group px-3.5 py-2 rounded-full flex items-center gap-2 text-slate-600 dark:text-[#cfb0ba] hover:text-[#9c5b6f] dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/5 transition-all duration-300 cursor-pointer text-xs font-semibold"
                    aria-label={tab.name}
                  >
              ...
              return (
                <Link
                  ...
                  className={`relative px-3.5 py-2 rounded-full flex items-center gap-2 text-xs font-bold transition-all duration-300 cursor-pointer ${
                    isTabActive
                      ? "bg-[#9c5b6f] text-white shadow-lg shadow-[#9c5b6f]/30"
